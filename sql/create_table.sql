...
-- 创建库
create database if not exists liangzaiOJ;
...
(
    ...
    judgeConfig text                               null comment '判题配置（json对象，比时间和空间限制）',
...
(
    ...
    judgeInfo text                               null comment '判题信息（json对象）,
                            比如判题信息，消耗时间，消耗内存     判题信息：成功，答案错误，超时等 ',
    status     int default 0 not null comment '状态：0-未判题，1-判题中，2-成功，3-失败',
